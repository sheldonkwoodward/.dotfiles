...
then
  ...
  brew install bash-completion bat cowsay diff-so-fancy exa fd fzf git htop lolcat micro ncdu node pipenv prettyping python2 python3 tldr trash tree vim
